...
/**
 * Fetch a single property by ID using the /metro/properties/ endpoint
 * The /listings endpoint doesn't have a specific ID endpoint, so we use metro properties
 */
export async function getPropertyById(id) {
  try {
    const url = `/metro/properties/${id}`;
...
/**
 * Fetch similar properties using /listings endpoint
 */
